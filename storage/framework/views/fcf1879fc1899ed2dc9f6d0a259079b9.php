...
<div class="row g-4">
  <div class="col-lg-5">
    <div class="sv-card">
      ...
      <form method="POST" action="<?php echo e(route('admin.coupons.store')); ?>"><?php echo csrf_field(); ?>
        <div class="row g-3">
  ...
  <div class="col-lg-7"><div class="sv-card"><div style="overflow-x:auto"><table class="sv-table">
    ...
    <tbody><?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td><strong><?php echo e($c->code); ?></strong></td>
      <td><?php echo e($c->type); ?></td>
      <td><?php echo e($c->type==='percent'?$c->value.'%':number_format($c->value,2).' AED'); ?></td>
      <td><?php echo e($c->used_count); ?><?php if($c->max_uses): ?>/<?php echo e($c->max_uses); ?><?php endif; ?></td>
      <td style="color:#999"><?php echo e($c->expires_at?->format('d M Y') ?? 'Never'); ?></td>
      <td><span class="sv-badge <?php echo e($c->is_active?'sv-b-active':'sv-b-inactive'); ?>"><?php echo e($c->is_active?'Active':'Off'); ?></span></td>
      <td><form method="POST" action="<?php echo e(route('admin.coupons.destroy',$c->id)); ?>" onsubmit="return confirm('Delete?')"><?php echo csrf_field(); ?>@method('DELETE')<button class="btn btn-sm btn-outline-danger" style="font-size:11px">Del</button></form></td>
    </tr><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></tbody>
  </table></div><div class="mt-3"><?php echo e($coupons->links()); ?></div></div></div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\stylevera_project\resources\views/admin/coupons/index.blade.php ENDPATH**/ ?>