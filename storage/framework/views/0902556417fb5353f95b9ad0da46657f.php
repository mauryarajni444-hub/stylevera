...
<div class="gs-wrap">
    ...
    <div class="gs-hud">
        <div class="gs-pill">🏆 Best <b id="gsBestLabel"><?php echo e($best); ?></b></div>
    ...
    <div class="gs-stage" id="gsStage">
        ...
        <div class="gs-overlay hidden" id="gsOverOverlay">
            ...
            <div style="display:flex; gap:12px; margin-top:6px;">
                ...
                <a href="<?php echo e(route('game.leaderboard')); ?>" class="gs-btn-ghost" style="text-decoration:none; display:inline-block;">Leaderboard</a>
            </div>
        </div>
    </div>
</div>
...
(function () {
    ...
    function submitScore(finalScore, cBest) {
        fetch("<?php echo e(route('game.score')); ?>", {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\stylevera_project\resources\views/frontend/game.blade.php ENDPATH**/ ?>