<?php $__env->startSection('title',app()->getLocale()==='ar'?'الدفع — ستايل فيرا':'Checkout — Stylevera'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sv-breadcrumb">
        <div class="container">
            ...
            <strong><?php echo e($locale==='ar'?'الدفع':'Checkout'); ?></strong>
        </div>
    </div>

    <div class="container py-5">
        <form action="<?php echo e(route('checkout.store')); ?>" method="POST" id="svCheckoutForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div style="font-size:11px;font-weight:800;letter-spacing:3px;text-transform:uppercase;color:var(--sv-muted);margin-bottom:16px">
                        <?php echo e($locale==='ar'?'01 — بيانات الشحن':'01 — Shipping Details'); ?>

                    </div>
                    <div class="row g-3 mb-5">
                        <div class="col-sm-6">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'الاسم الكامل':'Full Name'); ?></label>
                            <input name="name" class="sv-card-input" value="<?php echo e(auth()->user()?->name); ?>" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'البريد الإلكتروني':'Email Address'); ?></label>
                            <input name="email" type="email" class="sv-card-input" value="<?php echo e(auth()->user()?->email); ?>" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'الهاتف':'Phone Number'); ?></label>
                            <input name="phone" class="sv-card-input" required>
                        </div>
                        <div class="col-sm-6">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'المدينة':'City'); ?></label>
                            <input name="city" class="sv-card-input" value="Dubai" required>
                        </div>
                        <div class="col-12">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'العنوان الكامل':'Full Address'); ?></label>
                            <input name="address" class="sv-card-input" required>
                        </div>
                        <div class="col-12">
                            <label class="sv-card-label"><?php echo e($locale==='ar'?'ملاحظات (اختياري)':'Order Notes (optional)'); ?></label>
                    ...
                    <div style="font-size:11px;font-weight:800;letter-spacing:3px;text-transform:uppercase;color:var(--sv-muted);margin-bottom:16px">
                        <?php echo e($locale==='ar'?'02 — طريقة الدفع':'02 — Payment Method'); ?>
                    ...
                    <div id="svSectionCOD" class="sv-cod-box mb-4">
                        ...
                        <h5 style="font-size:16px;font-weight:700;color:var(--sv-text);margin-bottom:8px"><?php echo e($locale==='ar'?'الدفع عند الاستلام':'Cash on Delivery'); ?></h5>
                        <p style="font-size:13.5px;margin:0"><?php echo e($locale==='ar'?'سيتم تحصيل المبلغ عند استلام الطلب. مجاني وآمن.':'Pay when your order arrives. Free and safe.'); ?></p>
                    </div>
                    ...
                    <div id="svSectionApple" style="display:none" class="sv-cod-box mb-4">
                        ...
                        <p style="font-size:13.5px;margin:0"><?php echo e($locale==='ar'?'ادفع بسرعة وأمان باستخدام Apple Pay.':'Pay quickly and securely using Apple Pay.'); ?></p>
                    ...
                    <div id="svSectionCard" style="display:none">
                        ...
                        <div class="sv-card-form">
                            <div class="sv-card-form-group">
                                <label class="sv-card-label"><?php echo e($locale==='ar'?'اسم صاحب البطاقة':'Name on Card'); ?></label>
                            ...
                            <div class="sv-card-form-group">
                                <label class="sv-card-label"><?php echo e($locale==='ar'?'رقم البطاقة':'Card Number'); ?></label>
                                <div class="sv-card-input-wrap">
              ...
              <span style="font-size:17px;font-weight:900;font-style:italic;color:#1a5abb">VISA</span>
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <label class="sv-card-label"><?php echo e($locale==='ar'?'تاريخ الانتهاء':'Valid Through'); ?></label>
                                ...
                                <div class="col-6">
                                    <label class="sv-card-label"><?php echo e($locale==='ar'?'رمز الأمان':'CVV / CVC'); ?></label>
                        ...
                        <div class="sv-pay-panel mt-4" id="svPayPanel" style="display:none">
                            <div class="sv-pay-panel-header">
                                <div class="sv-pay-panel-title"><?php echo e($locale==='ar'?'تفاصيل الدفع':'Payment Details'); ?></div>
                                <div class="sv-secure-badge"><i class="bi bi-shield-check"></i></div>
                            </div>
                            <div class="sv-pay-panel-body">
                                <div class="sv-pay-row">
                                    <div class="sv-pay-row-label"><?php echo e($locale==='ar'?'اسم صاحب البطاقة':'Name on Card'); ?></div>
                                    <div class="sv-pay-row-val" id="pdName">—</div>
                                </div>
                                <div class="sv-pay-row">
                                    <div class="sv-pay-row-label"><?php echo e($locale==='ar'?'رقم البطاقة':'Card Number'); ?></div>
                                ...
                                <div class="sv-pay-row">
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <div class="sv-pay-row-label"><?php echo e($locale==='ar'?'صالح حتى':'Valid Through'); ?></div>
                                ...
                                <div class="sv-pay-valid-box" id="svPayValid" style="display:none">
                                    ...
                                    <div class="sv-pay-valid-text">
                                        <strong><?php echo e($locale==='ar'?'معلومات الدفع صحيحة':'Payment information is valid'); ?></strong>
                                        <span><?php echo e($locale==='ar'?'يمكنك المتابعة بأمان.':'You can safely proceed with your transaction.'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sv-security-bar mt-4">
                            <?php $__currentLoopData = [['bi-lock-fill','Secure Payment'],['bi-shield-lock-fill','256-bit Encryption'],['bi-patch-check-fill','Verified Card'],['bi-credit-card-fill','Visa Trusted']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="sv-sec-item">
                                    <div class="sv-sec-icon"><i class="bi <?php echo e($icon); ?>"></i></div>
                        ...
                        <div class="sv-secure-footer">
                            ...
                            <?php echo e($locale==='ar'?'معلومات الدفع الخاصة بك آمنة ومشفرة':'Your payment information is secure and encrypted'); ?>
                ...
                <div class="col-lg-5">
                    <div style="position:sticky;top:80px">
                        <div class="sv-card mb-3">
                            <div class="sv-card-title"><?php echo e($locale==='ar'?'ملخص الطلب':'Order Summary'); ?></div>
                            ...
                            <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="d-flex gap-3 mb-3 pb-3" style="border-bottom:1px solid var(--sv-border)">
                                    <div style="width:52px;height:68px;border-radius:5px;overflow:hidden;flex-shrink:0;background:var(--sv-bg-alt)">
                                        <?php if($img): ?><img src="<?php echo e($img); ?>" style="width:100%;height:100%;object-fit:cover" onerror="this.parentNode.innerHTML='<div style=\'width:100%;height:100%;background:var(--sv-bg-alt)\'></div>'"><?php endif; ?>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div style="font-size:13px;font-weight:600"><?php echo e($item->product->nameLocale()); ?></div>
                                        <?php if($item->variant): ?><div style="font-size:11px;color:var(--sv-muted)"><?php echo e($item->variant->nameLocale()); ?></div><?php endif; ?>
                                        <div style="font-size:12px;color:var(--sv-muted);margin-top:2px">× <?php echo e($item->quantity); ?></div>
                                    </div>
                                    <div style="font-size:13px;font-weight:600;white-space:nowrap"><?php echo e(number_format($item->price*$item->quantity,2)); ?> AED</div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <div class="d-flex justify-content-between mb-2" style="font-size:13px"><span><?php echo e($locale==='ar'?'المجموع الفرعي':'Subtotal'); ?></span><span><?php echo e(number_format($cart->total(),2)); ?> AED</span></div>
                            <div class="d-flex justify-content-between mb-2" style="font-size:13px">
                                <span><?php echo e($locale==='ar'?'الشحن':'Shipping'); ?></span>
                                <span><?php echo e($fee > 0 ? number_format($fee,2).' AED' : ($locale==='ar'?'مجاني':'Free')); ?></span>
                            </div>
                            <div id="svDiscountRow" style="display:none;font-size:13px" class="d-flex justify-content-between mb-2 text-success">
                                <span><?php echo e($locale==='ar'?'خصم':'Discount'); ?></span><span class="sv-disc-val"></span>
                            </div>
                            <hr style="border-color:var(--sv-border)">
                            <div class="d-flex justify-content-between fw-bold" style="font-size:16px">
                                <span><?php echo e($locale==='ar'?'الإجمالي':'Total'); ?></span>
                                <span id="svFinalTotal"><?php echo e(number_format($total,2)); ?> AED</span>
                            </div>

                            
                            <div class="d-flex gap-2 mt-3">
                                <input id="svCouponCode" class="sv-card-input" placeholder="<?php echo e($locale==='ar'?'كود الخصم':'Coupon code'); ?>" style="flex:1;padding:10px 13px;font-size:13px">
                                <button type="button" id="svApplyCoupon" class="btn btn-outline-dark text-uppercase" style="font-size:11px;letter-spacing:1px;white-space:nowrap">
                                    <?php echo e($locale==='ar'?'تطبيق':'Apply'); ?>
                        ...
                        <button type="submit" class="sv-place-order-btn cod-btn" id="svPlaceOrderBtn">
                            <span id="svBtnText">🚚 <?php echo e($locale==='ar'?'تأكيد الطلب':'Place Order — Cash on Delivery'); ?></span>
                        </button>
                        ...
                        <div style="text-align:center;margin-top:14px;font-size:12px;color:var(--sv-muted)">
                            ...
                            <?php echo e($locale==='ar'?'بيئة دفع آمنة ومشفرة بالكامل':'Fully encrypted & secure checkout'); ?>
    ...
    <div class="sv-processing" id="svProcessing">
        <div class="sv-processing-box">
            <div id="svProcSpinner">
                ...
                <div class="sv-processing-title"><?php echo e($locale==='ar'?'جاري معالجة الدفع...':'Processing Payment...'); ?></div>
                <div class="sv-processing-sub"><?php echo e($locale==='ar'?'الرجاء الانتظار':'Please wait a moment'); ?></div>
                <div class="sv-processing-steps mt-3">
                    <div class="sv-proc-step" id="step1"><i class="bi bi-circle"></i> <?php echo e($locale==='ar'?'التحقق من البطاقة':'Verifying card details'); ?></div>
                    <div class="sv-proc-step" id="step2"><i class="bi bi-circle"></i> <?php echo e($locale==='ar'?'الاتصال بالمصرف':'Connecting to bank'); ?></div>
                    <div class="sv-proc-step" id="step3"><i class="bi bi-circle"></i> <?php echo e($locale==='ar'?'تأمين المعاملة':'Securing transaction'); ?></div>
                    <div class="sv-proc-step" id="step4"><i class="bi bi-circle"></i> <?php echo e($locale==='ar'?'تأكيد الدفع':'Confirming payment'); ?></div>
                </div>
            </div>
            <div id="svProcSuccess" style="display:none">
                <div class="sv-success-ring">✓</div>
                <div class="sv-processing-title" style="color:#22c55e"><?php echo e($locale==='ar'?'تم الدفع بنجاح!':'Payment Successful!'); ?></div>
                <div class="sv-processing-sub"><?php echo e($locale==='ar'?'جاري تأكيد طلبك...':'Confirming your order...'); ?></div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function svSelectPayment(method) {
            ...
            if (method === 'card') {
                ...
                text.innerHTML = '🔒 <?php echo e($locale==='ar'?'ادفع الآن':'Pay Now'); ?> — <?php echo e(number_format($total,2)); ?> AED';
            } else if (method === 'apple') {
                btn.classList.remove('cod-btn');
                btn.style.background = 'linear-gradient(135deg,#1a1a1a,#333)';
                text.innerHTML = ' Pay — <?php echo e(number_format($total,2)); ?> AED';
            } else {
                btn.classList.add('cod-btn');
                btn.style.background = '';
                text.innerHTML = '🚚 <?php echo e($locale==='ar'?'تأكيد الطلب':'Place Order'); ?> — <?php echo e($locale==='ar'?'الدفع عند الاستلام':'Cash on Delivery'); ?>';
            }
        }
        ...
        document.getElementById('svCheckoutForm').addEventListener('submit', function(e) {
            ...
            if (method === 'card') {
                ...
                if (!name || num.length < 15 || exp.length < 4 || cvv.length < 3) {
                    svToast('<?php echo e($locale==='ar'?'يرجى إكمال بيانات البطاقة':'Please complete all card details'); ?>', 'error');
                    // Shake the form
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\stylevera_project\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>